...
function Slug() {
  const { idFil } = useSelector((s) => s.shop);
                  ...
                  <div className="flex flex-col gap-[24px] md:gap-[32px]">
                    ...
                    <div className="flex flex-row items-center justify-between">
                      ...
                      <button
                        ...
                        className="py-[15px]  px-[32px] bg-[#D87D4A] text-[#ffffff] text-[13px] font-bold leading-[18px] tracking-[1px] uppercase hover:bg-[#fbaf85]"
                      >
                        ADD TO CART
                      </button>
                    </div>
